...
MIGRATION_MODULES = {"sites": "essayfeeds.contrib.sites.migrations"}
...
ADMINS = [("""Jeckonia, Daniel and Sammy""", "inctifra@example.com")]
...
ACCOUNT_FORMS = {"signup": "essayfeeds.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "essayfeeds.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "essayfeeds.users.forms.UserSocialSignupForm"}
# django-compressor
# ------------------------------------------------------------------------------
...
SPECTACULAR_SETTINGS = {
    "TITLE": "essayfeeds API",
    "DESCRIPTION": "Documentation of API endpoints of essayfeeds",
    "VERSION": "1.0.0",
